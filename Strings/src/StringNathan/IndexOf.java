...
public class IndexOf 
{
	...
	public static void main(String[] args) 
	{
		...
		//indexOf will only find the first instance
		System.out.println("The first instance of "+ find1 +" is at index: "+ word.indexOf('b'));
		...
		//output is -1, means the the item is not in the string
